...
public class ShiroConfiguration {
    ...
    public SimpleShiroRealm shiroRealm() {
		SimpleShiroRealm realm = new SimpleShiroRealm(); 
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(){
		...
		filterChainDefinitionManager.put("/api/stats", "anon");
		//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑请在此区域内增加新的拦截规则 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
	...
	public FormAuthenticationFilter getFormAuthenticationFilter(){
		return new SimpleFormAuthenticationFilterr();
	}*/
